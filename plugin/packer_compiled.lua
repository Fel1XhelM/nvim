...
_G.packer_plugins = {
  LuaSnip = {
    config = { "\27LJ\2\n‘\1\0\0\3\0\6\0\f6\0\0\0'\2\1\0B\0\2\0029\0\2\0B\0\1\0016\0\0\0'\2\3\0B\0\2\0029\0\4\0005\2\5\0B\0\2\1K\0\1\0\1\0\1\npaths!~/.config/nvim/lua/snippets/\tload\29luasnip.loaders.from_lua\nsetup\fluasnip\frequire\0" },
    loaded = true,
  ...
  nerdtree = {
    ...
    needs_bufread = false,
    only_cond = false,
    path = "/data/data/com.termux/files/home/.local/share/nvim/site/pack/packer/opt/nerdtree",
  ...
  ["vim-quickui"] = {
    loaded = true,
    path = "/data/data/com.termux/files/home/.local/share/nvim/site/pack/packer/start/vim-quickui",
